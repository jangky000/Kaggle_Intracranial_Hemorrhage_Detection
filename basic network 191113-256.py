...
class Basic_conv2d_256_Net(nn.Module):
    def __init__(self):
        super(Basic_conv2d_256_Net, self).__init__()
...
# np.save("./basic/training_loss.npy", training_loss)
# np.save("./basic/validation_loss.npy", validation_loss)
# np.save("./basic/train_avg_dif.npy", train_avg_dif)
# np.save("./basic/valid_avg_dif.npy", valid_avg_dif)
...
x = np.load("./basic/training_loss.npy")
x
