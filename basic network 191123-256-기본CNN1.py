...
class Basic_CNN_1_VGG16Net(nn.Module):
    def __init__(self):
        super(Basic_CNN_1_VGG16Net, self).__init__()
...
np.save("./cnn1/training_loss.npy", training_loss)
np.save("./cnn1/validation_loss.npy", validation_loss)
np.save("./cnn1/train_avg_dif.npy", train_avg_dif)
np.save("./cnn1/valid_avg_dif.npy", valid_avg_dif)
