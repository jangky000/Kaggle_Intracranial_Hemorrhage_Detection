...
class Basic_CNN_2_VGG16_BN_Net(nn.Module):
    def __init__(self):
        super(Basic_CNN_2_VGG16_BN_Net, self).__init__()
...
model = Basic_CNN_2_VGG16_BN_Net()
print(model)
...
#             print(v_cnt," valid ground trust 결과값 : ", target)
    ...
    if valid_loss <= valid_loss_min:
        ...
        valid_loss_min,
        valid_loss))
        torch.save(model.state_dict(), 'model_cifar3.pt')
...
np.save("./cnn2/training_loss.npy", training_loss)
np.save("./cnn2/validation_loss.npy", validation_loss)
np.save("./cnn2/train_avg_dif.npy", train_avg_dif)
np.save("./cnn2/valid_avg_dif.npy", valid_avg_dif)
